...
However, if you plan to go only ocassionally on outdoor trips or to a trip where you need to carry less weight then buying a superlight tent might be a better option even so you may compromise with the durability of the tent. The list contains only a selection of new tents and I might add a few more later on. The table below is sorted by the weight of the tents and I have only listed the smallest or an updated model of a series.
