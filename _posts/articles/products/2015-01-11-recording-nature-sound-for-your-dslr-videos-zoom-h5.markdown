...
# Improving Lightning
This blog post is obviously about recording audio. However, I recently discovered that Manfrotto has a really nice and compact LED light which I would like to mention here as well - the <a href="http://amzn.to/2eG3GnK" rel="nofollow" target="_blank">Manfrotto LUMIMUSE 8 LED Light</a> which I would like to use together with my Sennheiser MKE 600 for indoor interviews.
