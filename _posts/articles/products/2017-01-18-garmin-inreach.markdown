...
You may also have a look at the <a href="http://amzn.to/2jxxCqo" rel="nofollow">Garmin Fenix %X</a> if you need a device with map functionality. This new smartwatch does not have SOS features but it's capable to store maps and display them on your wrist while on the trail.
