...
<a href="http://amzn.to/2eQufFk" rel="nofollow" target="blank"><button type="button" class="btn btn-danger">See on Amazon</button></a>
<!--more-->
<hr>
...
<a href="http://amzn.to/2f6NMq6" rel="nofollow" target="blank"><button type="button" class="btn btn-danger">See on Amazon</button></a>
