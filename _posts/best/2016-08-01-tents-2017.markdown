...
However, if you plan to go only ocassionally on outdoor trips or to a trip where you need to carry less weight then buying a superlight tent might be a better option even so you may compromise with the durability of the tent.

The table below is sorted by the weight of the tents and I have only listed the smallest or an updated model of a series. If you click on a link and you don't see the tent yet then it might not be available yet. The list below contains only a selection of new / updated tents and I might add a few more later on. The links on this site contain affiliate links. If you purchase through the links you help support our blog. <a href="http://www.hikeventures.com/about/" target="_blank">Here</a> you can read who we are.
