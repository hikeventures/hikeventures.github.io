...
However, if you plan to go only ocassionally on outdoor trips or if you are into ultralight backpacking then buying a superlight tent might be a better option even so you may compromise with the durability of the tent. The list below contains only a selection of new / updated tents and I might add a few more later on. This blog post contains affiliate links.
